<?php
	...
	$lg_activity = [
		...
		"head" => "Nous avons remarqué une activité inhabituelle",
		"body" => "Nous avons besoin de votre aide pour sécuriser votre compte afin d'empêcher tout accès non autorisé. Pour votre sécurité, il se peut que votre compte présente certaines limitations si les informations fournies ne sont pas correctes.",
		"bt_secure" => "Sécuriser mon compte"
	];	
	...
	$lg_auth = [
		"title" => "Auth. de sécurité 3-D",
		"sms_error" => "Code SMS expiré ! Veuillez ressaisir votre code.",
		"success" => "La sécurité 3-D a été traitée avec succès ...",
		"processing" => "En traitement",
		"added" => "Sécurité en ligne ajoutée",
		"protect" => "aide à protéger votre",
		"sms_text" =>"Nous vous remercions de vous authentifier en saisissant le code de confirmation reçu sur votre téléphone. Cette authentification est obligatoire pour vérifier votre compte.",	
		"center" => "carte contre l'utilisation non autorisée en ligne - sans frais supplémentaires. À utiliser",
		"nextline" => "sur cette question et sur les futures. complétez cette page Vous allez créer la vôtre",
		...
		"cannot" => "Impossible d'accéder à votre",
